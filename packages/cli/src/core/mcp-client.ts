...
const METHOD_MAP: Record<string, keyof StorageAdapter> = {
  ...
  c4a_store_feat_lifecycle: "featLifecycle",
  c4a_store_feat_merge: "featMerge",
  c4a_store_feat_checklist: "featChecklist",
  c4a_store_update_workflow_step: "updateWorkflowStep",
