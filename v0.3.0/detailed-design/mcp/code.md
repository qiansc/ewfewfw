# 代码分析类：`c4a_code_*`（c4a-code-mcp）

## 2.1 `c4a_code_extract`（从代码中提取接口/类型/类）
...
## 2.2 `c4a_code_analyze`（分析代码结构与依赖）
...
## 2.4 `c4a_code_contract`（生成契约：OpenAPI/AsyncAPI/Proto）
